...
export const Modal = ({currSession,times,setTimes,time,index}) => {
    ...
    const toggleModal = () => {
      ...
      const handleDnf = () => {
        ...
        if(time.plusTwo == true){
          ...
          return{...t, time: value,plusTwo:!time.plusTwo, dnf: !time.dnf, oldValue: time.time-200}
  ...
  return ( <div className=''>
    ...
    <div className='modal-content'>
        ...
        <button className={time.plusTwo ? 'modifier-button active': 'modifier-button'} onClick={handlePlusTwo}>+2</button>
